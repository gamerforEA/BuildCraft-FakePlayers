...
public class BuildCraftBuilders extends BuildCraftMod
{
	...
	{
		BuildCraftCore.mainConfigManager.register("blueprints.serverDatabaseDirectory", "\"$MINECRAFT" + File.separator + "config" + File.separator + "buildcraft" + File.separator + "blueprints" + File.separator + "server\"", "DEPRECATED - USED ONLY FOR COMPATIBILITY", ConfigManager.RestartRequirement.GAME);
	...
	public void reloadConfig(ConfigManager.RestartRequirement restartType)
	{
		...
		{
			this.oldBlueprintServerDir = BuildCraftCore.mainConfigManager.get("blueprints.serverDatabaseDirectory").getString();
			this.oldBlueprintServerDir = JavaTools.stripSurroundingQuotes(this.replacePathVariables(this.oldBlueprintServerDir));
	...
	public static void loadRecipes()
	{
		...
		BCRegistry.INSTANCE.addCraftingRecipe(new ItemStack(architectBlock, 1), "btb", "ycy", "gCg", 'b', "dyeBlack", 't', BuildCraftCore.markerBlock, 'y', "dyeYellow", 'c', Blocks.crafting_table, 'g', "gearDiamond", 'C', new ItemStack(blueprintItem, 1));
	...
	public void serverAboutToStart(FMLServerAboutToStartEvent event)
	{
		...
		serverDB.init(new String[] { this.oldBlueprintServerDir, blueprintPath }, blueprintPath);
	}
