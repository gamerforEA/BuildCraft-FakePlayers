...
public final class BlockUtils
{
	...
	{
		return getFakePlayerWithTool(CoreProxy.proxy.getBuildCraftPlayer(world, x, y, z).get(), world, x, y, z, tool);
	}
	// TODO gamerforEA code end

	// TODO gamerforEA add EntityPlayer parameter
	public static EntityPlayer getFakePlayerWithTool(EntityPlayer player, WorldServer world, int x, int y, int z, ItemStack tool)
	{
		int i = 0;
	...
	{
		return harvestBlock(getFakePlayerWithTool(world, x, y, z, tool), world, x, y, z, tool);
	}
	// TODO gamerforEA code end

	// TODO gamerforEA add EntityPlayer parameter
	public static boolean harvestBlock(EntityPlayer player1, WorldServer world, int x, int y, int z, ItemStack tool)
	{
		Block block = world.getBlock(x, y, z);
		int meta = world.getBlockMetadata(x, y, z);

		EntityPlayer player = getFakePlayerWithTool(player1, world, x, y, z, tool);
